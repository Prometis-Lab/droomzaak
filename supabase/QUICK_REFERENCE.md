...
**Live as of 2026-05-30** — 19 tables (18 loaded + `permit_rules` DDL added, data pending Task 4 load), loaded by `pipelines/droomzaak/load_to_supabase.py`.
